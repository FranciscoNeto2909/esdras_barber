  ...
  return (
    <>
      ...
      <section id='home' className=' h-screen w-full text-white md:flex items-center justify-center flex-col mt-8'>
        <div className='flex flex-col items-center overflow-hidden lg:flex-row md:gap-8'>
          <div className='h-80 w-96 relative mb-6 flex items-center justify-center animate-move'>
          ...
          <div className='max-w-xl px-2 md:p-0'>
            ...
            <p className='text-lg md:mt-4'>Entre em contato:</p>
      ...
      <section id='cuts' className='h-screen w-full text-white mt-20'>
        <h2 className='text-2xl w-max mb-12 pl-2' style={{ fontFamily: 'Lugrasimo, cursive' }}>Tipos de Cortes</h2>
        <Slider items={cuts} />
      </section>
      <section id='lights' className='h-screen w-full text-white'>
        <h2 className='text-2xl mb-12 w-full pl-2' style={{ fontFamily: 'Lugrasimo, cursive' }}>Tipos de luzes</h2>
        <Slider items={lights} />
      </section>
